...
public final class BookServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpcProject.BookRequest,
      com.grpcProject.BookResponse> getGetBookMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBook",
      requestType = com.grpcProject.BookRequest.class,
      responseType = com.grpcProject.BookResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpcProject.BookRequest,
      com.grpcProject.BookResponse> getGetBookMethod() {
    io.grpc.MethodDescriptor<com.grpcProject.BookRequest, com.grpcProject.BookResponse> getGetBookMethod;
      ...
      synchronized (BookServiceGrpc.class) {
        if ((getGetBookMethod = BookServiceGrpc.getGetBookMethod) == null) {
          BookServiceGrpc.getGetBookMethod = getGetBookMethod =
              io.grpc.MethodDescriptor.<com.grpcProject.BookRequest, com.grpcProject.BookResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBook"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpcProject.BookRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpcProject.BookResponse.getDefaultInstance()))
  ...
  public static abstract class BookServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBook(com.grpcProject.BookRequest request,
        io.grpc.stub.StreamObserver<com.grpcProject.BookResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpcProject.BookRequest,
                com.grpcProject.BookResponse>(
  ...
  public static final class BookServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BookServiceBlockingStub> {
    ...
    /**
     */
    public com.grpcProject.BookResponse getBook(com.grpcProject.BookRequest request) {
  ...
  public static final class BookServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BookServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpcProject.BookResponse> getBook(
        com.grpcProject.BookRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BOOK:
          serviceImpl.getBook((com.grpcProject.BookRequest) request,
              (io.grpc.stub.StreamObserver<com.grpcProject.BookResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BookServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpcProject.Schema.getDescriptor();
    }
